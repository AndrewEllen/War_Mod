...
ClientPlayNetworking.registerGlobalReceiver(ClientboundWarheadRemovePayload.TYPE, (payload, context) -> {
		...
		ClientPlayConnectionEvents.DISCONNECT.register((listener,client)->ClientWarheadVisualManager.INSTANCE.clear());
		ClientLevelEvents.AFTER_CLIENT_LEVEL_CHANGE.register((client,level)->ClientWarheadVisualManager.INSTANCE.clear());
		registered=true;
	}
}