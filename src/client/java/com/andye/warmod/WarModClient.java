...
import com.andye.warmod.artillery.client.render.ArtilleryWarheadRenderer;
import com.andye.warmod.artillery.client.audio.ClientArtilleryAudioManager;
...
import com.andye.warmod.silo.client.MissileWorkbenchBlockEntityRenderer;
import com.andye.warmod.silo.client.gui.MissileSiloScreen;
import com.andye.warmod.silo.client.gui.LaunchControllerScreen;
...
public final class WarModClient implements ClientModInitializer {
	...
	BlockEntityRenderers.register(ModBlockEntities.MISSILE_SILO, MissileSiloBlockEntityRenderer::new);
		BlockEntityRenderers.register(ModBlockEntities.MISSILE_WORKBENCH, MissileWorkbenchBlockEntityRenderer::new);
		...
		MenuScreens.register(ModMenus.LAUNCH_CONTROLLER, LaunchControllerScreen::new);
