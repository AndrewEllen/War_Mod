...
/** ICBM render types. Exhaust is routed through the full-bright emissive warhead pipeline. */
public final class IcbmRenderPipelines {
	private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(
		WarMod.MOD_ID, "textures/effect/icbm_albedo.png");

	public static final RenderType MISSILE = RenderType.create("war_mod_icbm",
		RenderSetup.builder(RenderPipelines.ENTITY_CUTOUT)
			.withTexture("Sampler0", TEXTURE).useLightmap().useOverlay().createRenderSetup());
	...
	public static final RenderType EXHAUST = WarheadRenderPipelines.ICBM_EXHAUST;
