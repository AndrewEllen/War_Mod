...
public record AntiAirFlightPlan(UUID interceptorId, @Nullable UUID ownerPlayerId, @Nullable UUID sourceSiloId,
    ...
    Vec3 launchPosition, Vec3 burnoutPosition, @Nullable AntiAirTargetLock targetLock,
    ...
    public AntiAirFlightPlan {
        ...
        if ((routeRequired && (targetLock == null || nominalSolution == null))
            || (!routeRequired && (targetLock != null || nominalSolution != null))
