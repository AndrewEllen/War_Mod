...
public record AntiAirFlightPlan(UUID interceptorId, @Nullable UUID ownerPlayerId, MissileAffiliation affiliation, @Nullable UUID sourceSiloId,
    ...
    public AntiAirFlightPlan {
        ...
        if ((routeRequired && (targetLock == null || nominalSolution == null || targetRootTrackId == null))
            ...
            || affiliation == null || launchPosition == null || burnoutPosition == null || noTargetHorizontalOffset == null
