...
public final class AcousticSounds {
	public static final Identifier LARGE_EXPLOSION_ID=id("large_explosion"),ICBM_ENGINE_RUMBLE_ID=id("icbm_engine_rumble"),TERMINAL_DESCENT_RUSH_ID=id("terminal_descent_rush"),TERMINAL_SONIC_BOOM_ID=id("terminal_sonic_boom");
	...
	public static void register(){if(registered)return;
		...
		registered=true;WarMod.LOGGER.info("Registered four propagated acoustic definitions.");}
