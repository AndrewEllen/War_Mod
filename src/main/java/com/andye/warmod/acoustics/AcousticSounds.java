...
public final class AcousticSounds {
	public static final Identifier LARGE_EXPLOSION_ID=id("large_explosion"),ICBM_ENGINE_RUMBLE_ID=id("icbm_engine_rumble"),TERMINAL_DESCENT_RUSH_ID=id("terminal_descent_rush"),TERMINAL_SONIC_BOOM_ID=id("terminal_sonic_boom"),WARHEAD_IMPACT_THUD_ID=id("warhead_impact_thud"),TACTICAL_HE_EXPLOSION_ID=id("tactical_he_explosion");
