...
public final class ModSoundEvents {
	...
	public static final Identifier BULLET_IMPACT_BODY_NEAR_ID=id("bullet_impact_body_near"),BULLET_IMPACT_BODY_MEDIUM_ID=id("bullet_impact_body_medium"),BULLET_IMPACT_BODY_FAR_ID=id("bullet_impact_body_far"),BULLET_IMPACT_BODY_EXTREME_ID=id("bullet_impact_body_extreme");
	public static final Identifier BULLET_IMPACT_METAL_NEAR_ID=id("bullet_impact_metal_near"),BULLET_IMPACT_METAL_MEDIUM_ID=id("bullet_impact_metal_medium"),BULLET_IMPACT_METAL_FAR_ID=id("bullet_impact_metal_far"),BULLET_IMPACT_METAL_EXTREME_ID=id("bullet_impact_metal_extreme");
	public static final Identifier BULLET_PASS_METAL_NEAR_ID=id("bullet_pass_metal_near"),BULLET_PASS_METAL_MEDIUM_ID=id("bullet_pass_metal_medium"),BULLET_PASS_METAL_FAR_ID=id("bullet_pass_metal_far"),BULLET_PASS_METAL_EXTREME_ID=id("bullet_pass_metal_extreme");
	public static final Identifier EAR_RINGING_LIGHT_ID=id("ear_ringing_light"),EAR_RINGING_MEDIUM_ID=id("ear_ringing_medium"),EAR_RINGING_HEAVY_ID=id("ear_ringing_heavy");
	...
	public static final SoundEvent BULLET_IMPACT_BODY_NEAR=fixedRange(BULLET_IMPACT_BODY_NEAR_ID),BULLET_IMPACT_BODY_MEDIUM=fixedRange(BULLET_IMPACT_BODY_MEDIUM_ID),BULLET_IMPACT_BODY_FAR=fixedRange(BULLET_IMPACT_BODY_FAR_ID),BULLET_IMPACT_BODY_EXTREME=fixedRange(BULLET_IMPACT_BODY_EXTREME_ID);
	public static final SoundEvent BULLET_IMPACT_METAL_NEAR=fixedRange(BULLET_IMPACT_METAL_NEAR_ID),BULLET_IMPACT_METAL_MEDIUM=fixedRange(BULLET_IMPACT_METAL_MEDIUM_ID),BULLET_IMPACT_METAL_FAR=fixedRange(BULLET_IMPACT_METAL_FAR_ID),BULLET_IMPACT_METAL_EXTREME=fixedRange(BULLET_IMPACT_METAL_EXTREME_ID);
	public static final SoundEvent BULLET_PASS_METAL_NEAR=fixedRange(BULLET_PASS_METAL_NEAR_ID),BULLET_PASS_METAL_MEDIUM=fixedRange(BULLET_PASS_METAL_MEDIUM_ID),BULLET_PASS_METAL_FAR=fixedRange(BULLET_PASS_METAL_FAR_ID),BULLET_PASS_METAL_EXTREME=fixedRange(BULLET_PASS_METAL_EXTREME_ID);
	public static final SoundEvent EAR_RINGING_LIGHT=sound("ear_ringing_light"),EAR_RINGING_MEDIUM=sound("ear_ringing_medium"),EAR_RINGING_HEAVY=sound("ear_ringing_heavy");
	...
	public static void register() {
		...
		register(BULLET_IMPACT_BODY_NEAR_ID,BULLET_IMPACT_BODY_NEAR);register(BULLET_IMPACT_BODY_MEDIUM_ID,BULLET_IMPACT_BODY_MEDIUM);register(BULLET_IMPACT_BODY_FAR_ID,BULLET_IMPACT_BODY_FAR);register(BULLET_IMPACT_BODY_EXTREME_ID,BULLET_IMPACT_BODY_EXTREME);
		register(BULLET_IMPACT_METAL_NEAR_ID,BULLET_IMPACT_METAL_NEAR);register(BULLET_IMPACT_METAL_MEDIUM_ID,BULLET_IMPACT_METAL_MEDIUM);register(BULLET_IMPACT_METAL_FAR_ID,BULLET_IMPACT_METAL_FAR);register(BULLET_IMPACT_METAL_EXTREME_ID,BULLET_IMPACT_METAL_EXTREME);
		register(BULLET_PASS_METAL_NEAR_ID,BULLET_PASS_METAL_NEAR);register(BULLET_PASS_METAL_MEDIUM_ID,BULLET_PASS_METAL_MEDIUM);register(BULLET_PASS_METAL_FAR_ID,BULLET_PASS_METAL_FAR);register(BULLET_PASS_METAL_EXTREME_ID,BULLET_PASS_METAL_EXTREME);
		register(EAR_RINGING_LIGHT_ID,EAR_RINGING_LIGHT);register(EAR_RINGING_MEDIUM_ID,EAR_RINGING_MEDIUM);register(EAR_RINGING_HEAVY_ID,EAR_RINGING_HEAVY);
