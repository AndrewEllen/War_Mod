...
public enum FirearmType {
    PISTOL(14.0, 0.024, 0.0016, 72, 6, 0.0035, 12.0F, 7.0F, 4.5F, 15),
    ASSAULT_RIFLE(19.0, 0.020, 0.0014, 88, 2, 0.0070, 15.0F, 8.5F, 5.5F, 30),
    SNIPER_RIFLE(26.0, 0.015, 0.0018, 112, 20, 0.00035, 40.0F, 16.0F, 9.0F, 5);
    ...
    FirearmType(final double muzzleSpeed, final double gravity,
        ...
        final float legDamage, final int magazineCapacity) {
    ...
    public int magazineCapacity() { return magazineCapacity; }
