...
public final class PhalanxConstants {
    ...
    /**
     * Extra simulation time after the predicted interception time.
     *
     * Bullet lifetime itself is calculated separately for every shot so
     * altitude does not create an arbitrary engagement-distance cap.
     */
    public static final int BULLET_LIFETIME_SAFETY_TICKS = 12;

    /**
     * This is an X/Z radius only. Vertical distance is not included.
     *
     * The resulting defended cylinder has a 400-block diameter.
     */
    public static final double
        HORIZONTAL_ENGAGEMENT_RADIUS_BLOCKS = 200.0;
