...
public final class ModItems {
	public static final ResourceKey<Item> ACOUSTIC_TEST_STICK_KEY=key("acoustic_test_stick"),ICBM_TEST_STICK_KEY=key("icbm_test_stick"),NUCLEAR_TEST_STICK_KEY=key("nuclear_test_stick"),NUCLEAR_ICBM_TEST_STICK_KEY=key("nuclear_icbm_test_stick");
