...
public final class IcbmConstants {
    ...
    public static final double MAXIMUM_BOOST_HORIZONTAL_DRIFT_BLOCKS = 224.0;
    public static final double MINIMUM_BOOST_FORWARD_LEAD_BLOCKS = 96.0;
    public static final double MAXIMUM_BOOST_FORWARD_LEAD_BLOCKS = 192.0;
    public static final double BOOST_FORWARD_LEAD_DISTANCE_FRACTION = 0.055;
