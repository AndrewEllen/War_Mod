...
public final class IcbmConstants {
    ...
    /* Give the powered carrier room to establish a broad down-range bank. */
    public static final double MAXIMUM_BOOST_HORIZONTAL_DRIFT_BLOCKS = 384.0;
    public static final double MINIMUM_BOOST_FORWARD_LEAD_BLOCKS = 160.0;
    public static final double MAXIMUM_BOOST_FORWARD_LEAD_BLOCKS = 320.0;
    public static final double BOOST_FORWARD_LEAD_DISTANCE_FRACTION = 0.085;
    public static final double BOOST_ASCENT_CONTROL_DISTANCE = 104.0;
