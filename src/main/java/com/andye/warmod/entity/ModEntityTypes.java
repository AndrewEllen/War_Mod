...
public final class ModEntityTypes {
	...
	public static final EntityType<RocketProjectileEntity> ROCKET_PROJECTILE=EntityType.Builder.<RocketProjectileEntity>of(RocketProjectileEntity::new,MobCategory.MISC).sized(.30F,.30F).noSummon().clientTrackingRange(40).updateInterval(1).build(ROCKET_PROJECTILE_KEY);
