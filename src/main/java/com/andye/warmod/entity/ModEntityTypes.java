...
public static final EntityType<ArtilleryWarheadEntity> ARTILLERY_WARHEAD=EntityType.Builder.<ArtilleryWarheadEntity>of(ArtilleryWarheadEntity::new,MobCategory.MISC).sized(.45F,1.25F).noSummon().clientTrackingRange(192).updateInterval(1).build(ARTILLERY_WARHEAD_KEY);
