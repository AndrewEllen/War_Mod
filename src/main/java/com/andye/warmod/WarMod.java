...
public final class WarMod implements ModInitializer {
	...
	@Override public void onInitialize(){ModSoundEvents.register();AcousticSounds.register();AcousticNetworking.registerPayloadTypes();WarheadVisualNetworking.registerPayloadTypes();IcbmVisualNetworking.registerPayloadTypes();RadarNetworking.register();ModDataComponents.register();ModBlocks.register();ModBlockEntities.register();MissileSiloChunkTicketType.register();IcbmChunkTicketType.register();IcbmFlightControllerManager.register();IcbmPendingCommandLaunchManager.register();IcbmCommand.register();ModEntityTypes.register();ModItems.register();MissileSiloManager.registerLifecycle();ModParticleTypes.register();ServerTickEvents.END_LEVEL_TICK.register(level->{RadarTrackingService.tick(level);RadarSubscriptionManager.tick(level);});ServerLifecycleEvents.SERVER_STOPPING.register(RadarSubscriptionManager::stop);ServerLifecycleEvents.SERVER_STOPPED.register(server->RadarTrackingService.clearAll());LOGGER.info("War Mod initialized.");}
}
