...
public final class WarMod implements ModInitializer {
	...
	@Override public void onInitialize(){ModSoundEvents.register();AcousticSounds.register();AcousticNetworking.registerPayloadTypes();WarheadVisualNetworking.registerPayloadTypes();IcbmVisualNetworking.registerPayloadTypes();IcbmFlightControllerManager.register();ModEntityTypes.register();ModItems.register();ModParticleTypes.register();LOGGER.info("War Mod initialized.");}
}
