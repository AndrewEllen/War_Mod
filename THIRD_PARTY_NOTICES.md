...
The first Distant Acoustics prototype uses these CC0 OpenGameArt sound sources. Attribution is retained for provenance even though CC0 does not require it.

| Title | Author/uploader | Source page | Licence shown |
| --- | --- | --- | --- |
| 25 CC0 bang / firework SFX | rubberduck | https://opengameart.org/content/25-cc0-bang-firework-sfx | CC0 |
| Explosions | EZduzziteh | https://opengameart.org/content/explosions-4 | CC0 |
| Muffled Distant Explosion | NenadSimic | https://opengameart.org/content/muffled-distant-explosion | CC0 |
