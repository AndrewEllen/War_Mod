...
$profiles = @(
	@{
		Name = 'explosion_near'
		TargetPeakDb = -1.8
		Filter = "atrim=start=$leadingSilenceSeconds,asetpts=PTS-STARTPTS,highpass=f=28,lowpass=f=15000"
	},
	@{
		Name = 'explosion_medium'
		TargetPeakDb = -1.3
		Filter = "atrim=start=$leadingSilenceSeconds,asetpts=PTS-STARTPTS,highpass=f=28,lowpass=f=6000"
	},
	@{
		Name = 'explosion_far'
		TargetPeakDb = -1.5
		Filter = "atrim=start=$leadingSilenceSeconds,asetpts=PTS-STARTPTS,highpass=f=28,lowpass=f=2000,equalizer=f=110:t=q:w=1.1:g=2"
	},
	@{
		Name = 'explosion_extreme'
		TargetPeakDb = -1.2
		Filter = "atrim=start=$leadingSilenceSeconds,asetpts=PTS-STARTPTS,highpass=f=28,lowpass=f=950,acompressor=threshold=0.25:ratio=1.5:attack=2:release=80:makeup=1"
	}
)
